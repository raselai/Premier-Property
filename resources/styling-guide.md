...
Modern styling patterns for using MUI v7 sx prop with **Gilroy** for titles and **Montserrat** for text, inline styles, and theme integration with **Gold**, **Dark**, and **Grey** color palette.
...
- ✅ **Gilroy** font for titles/headings (font-weight: 700)
- ✅ **Montserrat** font for body text
- ✅ **Gold (#D4AF37)**, **Dark (#1A1A1A)**, **Grey (#8B8B8B)** color scheme
